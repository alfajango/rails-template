...
@recipes = ["core", "git", "railsapps", "setup", "readme", "gems", "testing", "email", "models", "controllers", "views", "routes", "frontend", "init", "apps4", "prelaunch", "saas", "extras", "admin", "email_dev"]
@prefs = {:apps4=>"none", :dev_webserver=>"puma", :prod_webserver=>"puma", :database=>"postgresql", :templates=>"haml", :unit_test=>"rspec", :integration=>"rspec-capybara", :fixtures=>"factory_girl", :frontend=>"foundation5", :form_builder=>"simple_form", :email=>"sendgrid", :authentication=>"devise", :devise_modules=>"confirmable", :authorization=>"none", :continuous_testing=>"none", :starter_app=>"home_app", :admin=>"activeadmin", :mailcatcher=>true, :mail_view=>true, :quiet_assets=>true, :local_env_file=>"foreman", :better_errors=>true, :ban_spiders=>false, :github=>false}
@gems = []
...
def copy_from_repo(filename, opts = {})
  repo = 'https://raw.github.com/alfajango/rails-composer/readme-markdown/files/'
